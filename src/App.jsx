    ...
    <div className="app-container" ref={containerRef}>
      ...
      <header className="header">
        ...
        <nav className="nav-links">
          <a href="mailto:mondalbusservices@gmail.com,mondalbusservices98@gmail.com">Email Us</a>
          <a href="https://wa.me/919836683826" target="_blank" rel="noopener noreferrer" className="phone-nav" style={{ display: 'inline-flex', alignItems: 'center', gap: '5px' }}>
